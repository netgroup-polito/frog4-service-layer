...
logging.basicConfig(filename='script1.log', level=log_level, format=log_format, datefmt='%m/%d/%Y %I:%M:%S %p')
...
try:
    ...
    request_dict = json.loads('{"session":{"device":{"mac":"11:11:11:aa:aa:aa", "port":"eth3"}}}')
