...
logging.basicConfig(filename='script2.log', level=log_level, format=log_format, datefmt='%m/%d/%Y %I:%M:%S %p')
...
try:
    ...
    request_dict = json.loads('{"session":{"device":{"mac":"22:22:22:bb:bb:bb", "port":"eth3"}}}')
